...
/* Abstract Variable Nodes - ns=2;s=ROOT_NODE */

static UA_StatusCode function_ex_nodeset_0_begin(UA_Server* server, UA_UInt16* ns)
{
    UA_StatusCode retVal = UA_STATUSCODE_GOOD;
    UA_ObjectAttributes attr = UA_ObjectAttributes_default;
    attr.displayName = UA_LOCALIZEDTEXT("", "Abstract Variable Nodes");
#ifdef UA_ENABLE_NODESET_COMPILER_DESCRIPTIONS
    attr.description = UA_LOCALIZEDTEXT("", "This is autogenerated start node.");
#endif
...
{
    return UA_Server_addNode_finish(server, UA_NODEID_STRING(ns[2], "ROOT_NODE"));
}

/* 11CYQ10CQ301XG51 - ns=2;s=BOPM1.11CYQ10CQ301XG51 */
...
static UA_StatusCode function_ex_nodeset_1_begin(UA_Server* server, UA_UInt16* ns)
{
    ...
    UA_Boolean* variablenode_ns_2_s_bopm1_11cyq10cq301xg51_variant_DataContents = UA_Boolean_new();
    if (!variablenode_ns_2_s_bopm1_11cyq10cq301xg51_variant_DataContents)
        return UA_STATUSCODE_BADOUTOFMEMORY;
    UA_Boolean_init(variablenode_ns_2_s_bopm1_11cyq10cq301xg51_variant_DataContents);
    *variablenode_ns_2_s_bopm1_11cyq10cq301xg51_variant_DataContents = (UA_Boolean) true;
    UA_Variant_setScalar(&attr.value, variablenode_ns_2_s_bopm1_11cyq10cq301xg51_variant_DataContents, &UA_TYPES[UA_TYPES_BOOLEAN]);
    attr.displayName = UA_LOCALIZEDTEXT("", "11CYQ10CQ301XG51");
#ifdef UA_ENABLE_NODESET_COMPILER_DESCRIPTIONS
    attr.description = UA_LOCALIZEDTEXT("", "HRSG compartment NO ALARM SIGNAL OF MPC (CO) 20 mg/m3/ (Threshold 1)");
#endif
    retVal |= UA_Server_addNode_begin(
        server,
...
{
    return UA_Server_addNode_finish(server, UA_NODEID_STRING(ns[2], "BOPM1.11CYQ10CQ301XG51"));
}

/* 11CYQ10CQ301XG53 - ns=2;s=BOPM1.11CYQ10CQ301XG53 */
...
static UA_StatusCode function_ex_nodeset_2_begin(UA_Server* server, UA_UInt16* ns)
{
    ...
    attr.valueRank = -2;
    attr.dataType = UA_NODEID_NUMERIC(ns[0], 1LU);
    UA_Boolean* variablenode_ns_2_s_bopm1_11cyq10cq301xg53_variant_DataContents = UA_Boolean_new();
    if (!variablenode_ns_2_s_bopm1_11cyq10cq301xg53_variant_DataContents)
        return UA_STATUSCODE_BADOUTOFMEMORY;
    UA_Boolean_init(variablenode_ns_2_s_bopm1_11cyq10cq301xg53_variant_DataContents);
    *variablenode_ns_2_s_bopm1_11cyq10cq301xg53_variant_DataContents = (UA_Boolean) false;
    UA_Variant_setScalar(&attr.value, variablenode_ns_2_s_bopm1_11cyq10cq301xg53_variant_DataContents, &UA_TYPES[UA_TYPES_BOOLEAN]);
    attr.displayName = UA_LOCALIZEDTEXT("", "11CYQ10CQ301XG53");
#ifdef UA_ENABLE_NODESET_COMPILER_DESCRIPTIONS
    attr.description = UA_LOCALIZEDTEXT("", "HRSG compartment NO ALARM SIGNAL OF MPC (CO) 100 mg/m3/ (Threshold 2)");
#endif
    retVal |= UA_Server_addNode_begin(
        server,
        UA_NODECLASS_VARIABLE,
        ...
        UA_QUALIFIEDNAME(ns[0], "11CYQ10CQ301XG53"),
        UA_NODEID_NUMERIC(ns[0], 2372LU),
        (const UA_NodeAttributes*)&attr,
        &UA_TYPES[UA_TYPES_VARIABLEATTRIBUTES],
        NULL,
...
{
    return UA_Server_addNode_finish(server, UA_NODEID_STRING(ns[2], "BOPM1.11CYQ10CQ301XG53"));
}

/* 11CYQ20CQ301XG51 - ns=2;s=BOPM1.11CYQ20CQ301XG51 */
...
static UA_StatusCode function_ex_nodeset_3_begin(UA_Server* server, UA_UInt16* ns)
{
    ...
    attr.valueRank = -2;
    attr.dataType = UA_NODEID_NUMERIC(ns[0], 1LU);
    UA_Boolean* variablenode_ns_2_s_bopm1_11cyq20cq301xg51_variant_DataContents = UA_Boolean_new();
    if (!variablenode_ns_2_s_bopm1_11cyq20cq301xg51_variant_DataContents)
        return UA_STATUSCODE_BADOUTOFMEMORY;
    UA_Boolean_init(variablenode_ns_2_s_bopm1_11cyq20cq301xg51_variant_DataContents);
    *variablenode_ns_2_s_bopm1_11cyq20cq301xg51_variant_DataContents = (UA_Boolean) true;
    UA_Variant_setScalar(&attr.value, variablenode_ns_2_s_bopm1_11cyq20cq301xg51_variant_DataContents, &UA_TYPES[UA_TYPES_BOOLEAN]);
    attr.displayName = UA_LOCALIZEDTEXT("", "11CYQ20CQ301XG51");
#ifdef UA_ENABLE_NODESET_COMPILER_DESCRIPTIONS
    attr.description = UA_LOCALIZEDTEXT("", "Auxiliary compartment NO ALARM SIGNAL OF MPC  (CO) 20 mg/m3/ (Threshold 1)");
#endif
    retVal |= UA_Server_addNode_begin(
        server,
        UA_NODECLASS_VARIABLE,
...
{
    return UA_Server_addNode_finish(server, UA_NODEID_STRING(ns[2], "BOPM1.11CYQ20CQ301XG51"));
}

/* 11CYQ20CQ301XG53 - ns=2;s=BOPM1.11CYQ20CQ301XG53 */
...
static UA_StatusCode function_ex_nodeset_4_begin(UA_Server* server, UA_UInt16* ns)
{
    ...
    attr.valueRank = -2;
    attr.dataType = UA_NODEID_NUMERIC(ns[0], 1LU);
    UA_Boolean* variablenode_ns_2_s_bopm1_11cyq20cq301xg53_variant_DataContents = UA_Boolean_new();
    if (!variablenode_ns_2_s_bopm1_11cyq20cq301xg53_variant_DataContents)
        return UA_STATUSCODE_BADOUTOFMEMORY;
    UA_Boolean_init(variablenode_ns_2_s_bopm1_11cyq20cq301xg53_variant_DataContents);
    *variablenode_ns_2_s_bopm1_11cyq20cq301xg53_variant_DataContents = (UA_Boolean) false;
    UA_Variant_setScalar(&attr.value, variablenode_ns_2_s_bopm1_11cyq20cq301xg53_variant_DataContents, &UA_TYPES[UA_TYPES_BOOLEAN]);
    attr.displayName = UA_LOCALIZEDTEXT("", "11CYQ20CQ301XG53");
#ifdef UA_ENABLE_NODESET_COMPILER_DESCRIPTIONS
    attr.description = UA_LOCALIZEDTEXT("", "Auxiliary compartment NO ALARM SIGNAL OF MPC  (CO) 100 mg/m3/ (Threshold 2)");
#endif
    retVal |= UA_Server_addNode_begin(
        server,
        UA_NODECLASS_VARIABLE,
...
{
    return UA_Server_addNode_finish(server, UA_NODEID_STRING(ns[2], "BOPM1.11CYQ20CQ301XG53"));
}

/* 11CYQ30CQ301XG51 - ns=2;s=BOPM1.11CYQ30CQ301XG51 */
...
static UA_StatusCode function_ex_nodeset_5_begin(UA_Server* server, UA_UInt16* ns)
{
    ...
    attr.valueRank = -2;
    attr.dataType = UA_NODEID_NUMERIC(ns[0], 1LU);
    UA_Boolean* variablenode_ns_2_s_bopm1_11cyq30cq301xg51_variant_DataContents = UA_Boolean_new();
    if (!variablenode_ns_2_s_bopm1_11cyq30cq301xg51_variant_DataContents)
        return UA_STATUSCODE_BADOUTOFMEMORY;
    UA_Boolean_init(variablenode_ns_2_s_bopm1_11cyq30cq301xg51_variant_DataContents);
    *variablenode_ns_2_s_bopm1_11cyq30cq301xg51_variant_DataContents = (UA_Boolean) true;
    UA_Variant_setScalar(&attr.value, variablenode_ns_2_s_bopm1_11cyq30cq301xg51_variant_DataContents, &UA_TYPES[UA_TYPES_BOOLEAN]);
    attr.displayName = UA_LOCALIZEDTEXT("", "11CYQ30CQ301XG51");
#ifdef UA_ENABLE_NODESET_COMPILER_DESCRIPTIONS
    attr.description = UA_LOCALIZEDTEXT("", "Turbine hall NO ALARM SIGNAL OF MPC (CO) 20 mg/m3/ (Threshold 1)");
#endif
    retVal |= UA_Server_addNode_begin(
        server,
        UA_NODECLASS_VARIABLE,
        UA_NODEID_STRING(ns[2], "BOPM1.11CYQ30CQ301XG51"),
        UA_NODEID_STRING(ns[2], "BOPM1.11CYQ20CQ301XG53"),
        UA_NODEID_NUMERIC(ns[0], 35LU),
        UA_QUALIFIEDNAME(ns[0], "11CYQ30CQ301XG51"),
        UA_NODEID_NUMERIC(ns[0], 2372LU),
        (const UA_NodeAttributes*)&attr,
        &UA_TYPES[UA_TYPES_VARIABLEATTRIBUTES],
        NULL,
...
{
    return UA_Server_addNode_finish(server, UA_NODEID_STRING(ns[2], "BOPM1.11CYQ30CQ301XG51"));
}
...
UA_StatusCode ex_nodeset(UA_Server* server)
{
    ...
    if ((retVal = function_ex_nodeset_34_begin(server, ns)) != UA_STATUSCODE_GOOD)
        return retVal;
    if ((retVal = function_ex_nodeset_35_begin(server, ns)) != UA_STATUSCODE_GOOD)
        return retVal;
    if ((retVal = function_ex_nodeset_36_begin(server, ns)) != UA_STATUSCODE_GOOD)
        return retVal;
    if ((retVal = function_ex_nodeset_37_begin(server, ns)) != UA_STATUSCODE_GOOD)
        return retVal;
    if ((retVal = function_ex_nodeset_38_begin(server, ns)) != UA_STATUSCODE_GOOD)
        return retVal;
    ...
    if ((retVal = function_ex_nodeset_38_finish(server, ns)) != UA_STATUSCODE_GOOD)
        return retVal;
    if ((retVal = function_ex_nodeset_37_finish(server, ns)) != UA_STATUSCODE_GOOD)
        return retVal;
    if ((retVal = function_ex_nodeset_36_finish(server, ns)) != UA_STATUSCODE_GOOD)
        return retVal;
    if ((retVal = function_ex_nodeset_35_finish(server, ns)) != UA_STATUSCODE_GOOD)
        return retVal;
