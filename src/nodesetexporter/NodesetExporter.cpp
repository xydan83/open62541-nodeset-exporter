    ...
    const Options& opt) noexcept
{
    ...
    try
    {
        ...
        static_assert(std::is_same<TOpen62541ServerOrClient, UA_Server>::value || std::is_same<TOpen62541ServerOrClient, UA_Client>::value, "Wrong type of TOpen62541ServerOrClient");
